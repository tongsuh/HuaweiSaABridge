...
import nodomain.freeyourgadget.gadgetbridge.service.devices.huawei.requests.SendVibrateRequest;
...
//            setWearMessagePushReq.doPerform();
    ...
    public SleepAsAndroidSender getSleepAsAndroidSender() {
        if (sleepAsAndroidSender == null && gbDevice != null) {
    ...
    public void onSleepAsAndroidAction(String action, android.os.Bundle extras) {
        ...
        switch (action) {
            ...
            case SleepAsAndroidAction.STOP_TRACKING:
                stopRealtimeWorkoutHeartrate();
                sender.stopTracking();
                break;
            case SleepAsAndroidAction.SET_SUSPENDED:
                boolean suspended = extras != null && extras.getBoolean("SUSPENDED", false);
                sender.pauseTracking(suspended);
                break;
            case SleepAsAndroidAction.SET_BATCH_SIZE:
                long batchSize = extras != null ? extras.getLong("SIZE", 12L) : 12L;
            ...
            case SleepAsAndroidAction.SHOW_NOTIFICATION:
                ...
                break;
            default:
                LOG.debug("Unhandled SleepAsAndroid action: " + action);
                break;
        }
    }
